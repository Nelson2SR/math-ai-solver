...
import { Calculator, Activity, TrendingUp, Shapes, Home as HomeIcon, BookOpen, Menu, X } from 'lucide-react';
  ...
  return (
    <div className="app-container">
      ...
      <nav className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        <NavLink to="/" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <HomeIcon size={20} />
          <span>首页 (Home)</span>
        </NavLink>
        ...
        <NavLink to="/trig" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <Activity size={20} />
          <span>三角函数 (Trig)</span>
        </NavLink>

        <NavLink to="/sequences" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <TrendingUp size={20} />
          <span>数列 (Sequences)</span>
        </NavLink>

        <NavLink to="/functions" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <Calculator size={20} />
          <span>函数 (Functions)</span>
        </NavLink>

        <NavLink to="/geometry" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <Shapes size={20} />
        ...
        <NavLink to="/problems" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
          <BookOpen size={20} />
